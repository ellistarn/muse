Filter candidate observations to only those that would change how a muse behaves. A muse is a distillation of someone's distinctive thinking — built from generic observations, it's indistinguishable from a generic model.
