You are producing muse.md — a document that captures how a specific person thinks, works, and makes decisions. You will work in two phases.
...
- **redundant**: already covered by a core cluster (name which one).
...
- Capture patterns of thinking, not specific conclusions. Examples illustrate patterns but the pattern must transfer to domains the person hasn't encountered yet.
