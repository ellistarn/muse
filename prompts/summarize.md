...
If the cluster contains observations with quotes, summarize the pattern first, then include one or two verbatim quotes that illustrate the pattern in action.
